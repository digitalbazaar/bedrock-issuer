...
config.issuer.identities[userName].identity.sysPreferences = {
  credentialSigningKey: config.issuer.identities[userName].keys.publicKey.id
};

userName = 'rsa4096nokey';
config.issuer.identities[userName] = {};
config.issuer.identities[userName].identity = createIdentity(userName);
