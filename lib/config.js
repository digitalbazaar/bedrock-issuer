...
// FIXME: GUI has been removed from this module
// pseudo bower package
/*
config.requirejs.bower.packages.push({
  path: path.join(__dirname, '..', 'components'),
  manifest: {
    name: 'bedrock-issuer-components',
    moduleType: 'amd',
    main: './main.js',
    dependencies: {
      angular: '~1.3.0'
...
// NOTE: This is critical the index.html file referenced here is from bedrock
// views module not from this module
// config.views.routes.push(['/issuer', 'issuer/credentials.html']);
config.views.routes.push(['/issuer', 'index.html']);
config.views.routes.push(['/issuer/dashboard', 'index.html']);
